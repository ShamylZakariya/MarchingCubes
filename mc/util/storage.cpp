...
namespace util {
    ...
    {
        CheckGlError("IndexedVertexStorage::_updateVertices enter");
        if (vertices.size() > _vertexStorageSize) {
            _vertexStorageSize = static_cast<std::size_t>(vertices.size() * _growthFactor);
            _numVertices = vertices.size();
        ...
        CheckGlError("IndexedVertexStorage::_updateVertices exit");
    }

    void IndexedVertexStorage::_updateIndices(const std::vector<GLuint>& indices)
    {
        CheckGlError("IndexedVertexStorage::_updateIndices enter");
        ...
        CheckGlError("IndexedVertexStorage::_updateIndices exit");
    }
